...
import helicpoter from "../assets/images/helicopterroadmap.43623f49ad616fe7878f.webp";
import TimelineDashed from "../assets/images/timelinedhased.f804cb524fb3e34bbdc2.webp";
import roadmap_img1 from "../assets/images/timelinechristmas.145f9d316205d030c106.webp";
import roadmap_img2 from "../assets/images/cristmascrocotime.9ed4bd498b97116cd959.webp";
import ghas_img from "../assets/images/timelinegrass.71d2b7a488849a9873db.webp";

const Roadmap = () => {
  return (
    <div
      id="Roadmap"
      className="bg-[#09655A] sm:pb-[100px] md:pb-[200px] xl:pb-[200px] pb-[40px] my-[-2px]"
    >
      <h2
        ...
        <div className="md:pl-0 sm:pl-[130px] pl-[70px]">
          ...
          >
            ...
            <img
              src={ghas_img}
              alt="#"
              className="md:hidden block absolute left-[-86px] sm:left-[-28%] bottom-[99px] sm:bottom-[-19px] max-w-[80px] sm:max-w-[120px]"
            />
          </div>
        </div>
        <div className="md:hidden block absolute sm:left-[70px] left-[40px] top-0 bottom-[110px] sm:bottom-0 w-[15px] border-l-[11px] border-dashed border-[#0a4740]"></div>
        <img
          src={TimelineDashed}
          alt="#"
